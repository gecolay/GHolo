...
public class GHoloRowItemContent extends Display.ItemDisplay implements IGHoloRowContentType {
    ...
    public GHoloRowItemContent(GHoloRow holoRow, GHoloMain gHoloMain) {
        ...
        try {
            ...
            for(Field field : ItemDisplay.class.getDeclaredFields()) if(field.getType().equals(EntityDataAccessor.class)) fieldList.add(field);
        ...
        if(content != null) {
            ...
            if(resourceLocation != null) {
                try {
                    ...
                    data.add(new SynchedEntityData.DataValue<>(holoItemData.id(), holoItemData.serializer(), itemData.getDefaultInstance()));
