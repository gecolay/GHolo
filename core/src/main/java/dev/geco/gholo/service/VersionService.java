...
public class VersionService {
    ...
    private final String LATEST_VERSION = "v26_3";
    ...
    public VersionService(GHoloMain gHoloMain) {
        ...
        packagePath = gHoloMain.getClass().getPackage().getName() + ".mcv." + VERSION_MAPPING.getOrDefault(packageVersion, packageVersion);
